...
# Loads dataframe and config
    df = spark.read.format("libsvm")\
        .load("C:/Users/User/Desktop/spark-master/data/mllib/sample_isotonic_regression_libsvm_data.txt")
#    df = MLUtils.loadLibSVMFile(sc, "C:\Users\User\Desktop\spark-master\data\mllib\sample_isotonic_regression_libsvm_data.txt")
...
#    Showing R-square using test data
    def r_square(col_prediction, col_label):
        ...
        """    
        ir_evaluator = RegressionEvaluator(predictionCol=col_prediction,                  labelCol=col_label, metricName="r2")
